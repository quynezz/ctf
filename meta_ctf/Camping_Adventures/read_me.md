...
Format a little bit to match with the GPS format

`39°09'08.0"N 106°24'20.7"W`

Search it on `google map` and we found a lake called `emerald lake`

We have flag: 

`Flag: metaCTF{emerale lake}`
